 ...
 * policies never hang an agent turn.
 *
...
class BrowserSession {
	...
	/** Launch the configured channel, falling back to bundled Chromium when absent. */
	async launchBrowser() {
...
/** Trim a string to a UTF-8-safe char budget with a truncation note. */
